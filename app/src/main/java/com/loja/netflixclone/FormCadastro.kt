...
import com.loja.netflixclone.databinding.ActivityFormCadastroBinding
    ...
    private fun CadastrarUsuario(){
        ...
        FirebaseAuth.getInstance().createUserWithEmailAndPassword(email,senha).addOnCompleteListener {
            ...
            when{
                ...
                erro is FirebaseAuthUserCollisionException -> mensagem_erro.setText("Este email já está cadastrado")
